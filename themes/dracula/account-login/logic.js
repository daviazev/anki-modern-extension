/**
 * Dracula Theme - Account Login Page Logic
 * Aplica estilização Dracula à página de login
 */

(function () {
  'use strict';

  console.log('[Anki Modern - Dracula] Inicializando página Account Login...');
   ...
   */
  function init() {
    console.log('[Anki Modern - Dracula] Iniciando estilização Account Login...');

    // Adiciona classe identificadora ao body para aplicar estilos
    document.body.classList.add('anki-modern-account-login');

    console.log('[Anki Modern - Dracula] Account Login page inicializada com sucesso!');
  }
